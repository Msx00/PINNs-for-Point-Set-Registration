...
| Dataset | Method | RMSE (mm) / TRE (mm) ↓ | CD (mm) ↓ | %neg J ↓ |
|---------|--------|------------------------|-----------|----------|
| **Sim** | **Deformation (Ours)** | **0.219 ± 0.057** | **0.194 ± 0.057** | **0** |
...
|         | GMM-FEM                | 1.528 ± 0.912 | 0.916 ± 1.291 | 1.673 |
|         | BCPD                   | 2.326 ± 5.811 | 0.951 ± 2.669 | 0.013 |
| **Clin.** | **Deformation (Ours)** | **4.924 ± 1.542** | **2.125 ± 0.291** | 0.278 |
...
|          | GMM-FEM               | 5.899 ± 2.797 | 2.280 ± 0.289 | **24.976** |
|          | BCPD                  | 9.535 ± 6.907 | 3.952 ± 3.744 | **0.030** |
<details>
